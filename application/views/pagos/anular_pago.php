				...
				<div class="panel-body">
					 <form action="<?php echo base_url() ?>Recaudador/anular" method="post" class="form-horizontal">
					 	<div class="form-group"> 
							<label class="col-sm-2 control-label">Ingresar Número Talonario</label> 
							<div class="col-sm-10"> 
						...
						<div class="form-group"> 
							...
							<div class="col-sm-10"> 
								<div class="input-group"> 
									<input type="text" placeholder="Recibo" class="form-control" name="recibo" id="recibo"> 
									<span class="input-group-addon"><i class="icon-user-add"></i></span>
								</div>
							</div> 
						</div>
						<div class="row">
							<div class="form-group">
								...
								<div class="form-group"> 
									...
									<div class="col-sm-2"> 
										<div class="input-group"> 
											<input type="text" placeholder="Nombre Socio" class="form-control" name="socio_nombre" id="socio_nombre"> 
										</div>
									</div> 
									...
									<div class="col-sm-2"> 
										<div class="input-group"> 
											<input type="text" placeholder="Fecha de Pago" class="form-control" name="F_pago" id="F_pago"> 
										</div>
									</div> 
								</div>
								<br><br><br>
